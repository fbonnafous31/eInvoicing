...
\restrict hecjm6qIBQIBvv9370UtHh8gCMJZa0rUifKvHjOVZdW7hGNtMdLiLFckiPSrxch
...
--
-- Name: seller_smtp_settings; Type: TABLE; Schema: invoicing; Owner: francois
--
...
ALTER TABLE invoicing.seller_smtp_settings OWNER TO francois;

--
-- Name: TABLE seller_smtp_settings; Type: COMMENT; Schema: invoicing; Owner: francois
--
...
--
-- Name: COLUMN seller_smtp_settings.seller_id; Type: COMMENT; Schema: invoicing; Owner: francois
--
...
--
-- Name: COLUMN seller_smtp_settings.smtp_host; Type: COMMENT; Schema: invoicing; Owner: francois
--
...
--
-- Name: COLUMN seller_smtp_settings.smtp_port; Type: COMMENT; Schema: invoicing; Owner: francois
--
...
--
-- Name: COLUMN seller_smtp_settings.smtp_secure; Type: COMMENT; Schema: invoicing; Owner: francois
--
...
--
-- Name: COLUMN seller_smtp_settings.smtp_user; Type: COMMENT; Schema: invoicing; Owner: francois
--
...
--
-- Name: COLUMN seller_smtp_settings.smtp_pass; Type: COMMENT; Schema: invoicing; Owner: francois
--
...
--
-- Name: COLUMN seller_smtp_settings.smtp_from; Type: COMMENT; Schema: invoicing; Owner: francois
--
...
--
-- Name: COLUMN seller_smtp_settings.active; Type: COMMENT; Schema: invoicing; Owner: francois
--
...
--
-- Name: COLUMN seller_smtp_settings.created_at; Type: COMMENT; Schema: invoicing; Owner: francois
--
...
--
-- Name: COLUMN seller_smtp_settings.updated_at; Type: COMMENT; Schema: invoicing; Owner: francois
--
...
--
-- Name: seller_smtp_settings_id_seq; Type: SEQUENCE; Schema: invoicing; Owner: francois
--
...
ALTER SEQUENCE invoicing.seller_smtp_settings_id_seq OWNER TO francois;

--
-- Name: seller_smtp_settings_id_seq; Type: SEQUENCE OWNED BY; Schema: invoicing; Owner: francois
--

ALTER SEQUENCE invoicing.seller_smtp_settings_id_seq OWNED BY invoicing.seller_smtp_settings.id;
...
CREATE TABLE invoicing.sellers (
    ...
    plan character varying(20) DEFAULT 'essentiel'::character varying NOT NULL,
...
--
-- Name: COLUMN sellers.plan; Type: COMMENT; Schema: invoicing; Owner: francois
--
...
--
-- Name: seller_smtp_settings id; Type: DEFAULT; Schema: invoicing; Owner: francois
--

ALTER TABLE ONLY invoicing.seller_smtp_settings ALTER COLUMN id SET DEFAULT nextval('invoicing.seller_smtp_settings_id_seq'::regclass);
...
--
-- Name: seller_smtp_settings seller_smtp_settings_pkey; Type: CONSTRAINT; Schema: invoicing; Owner: francois
--

ALTER TABLE ONLY invoicing.seller_smtp_settings
    ADD CONSTRAINT seller_smtp_settings_pkey PRIMARY KEY (id);
...
--
-- Name: seller_smtp_settings seller_smtp_settings_seller_id_fkey; Type: FK CONSTRAINT; Schema: invoicing; Owner: francois
--

ALTER TABLE ONLY invoicing.seller_smtp_settings
    ADD CONSTRAINT seller_smtp_settings_seller_id_fkey FOREIGN KEY (seller_id) REFERENCES invoicing.sellers(id) ON DELETE CASCADE;
...
\unrestrict hecjm6qIBQIBvv9370UtHh8gCMJZa0rUifKvHjOVZdW7hGNtMdLiLFckiPSrxch
