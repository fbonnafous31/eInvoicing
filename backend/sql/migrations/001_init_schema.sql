...
CREATE SEQUENCE IF NOT EXISTS invoicing.clients_id_seq
	INCREMENT BY 1
	MINVALUE 1
	MAXVALUE 2147483647
	START 1
...
CREATE SEQUENCE IF NOT EXISTS invoicing.invoice_attachments_id_seq
	INCREMENT BY 1
	MINVALUE 1
	MAXVALUE 2147483647
	START 1
...
CREATE SEQUENCE IF NOT EXISTS invoicing.invoice_client_id_seq
	INCREMENT BY 1
	MINVALUE 1
	MAXVALUE 2147483647
	START 1
...
CREATE SEQUENCE IF NOT EXISTS invoicing.invoice_lines_id_seq
	INCREMENT BY 1
	MINVALUE 1
	MAXVALUE 2147483647
	START 1
...
CREATE SEQUENCE IF NOT EXISTS invoicing.invoice_status_id_seq
	INCREMENT BY 1
	MINVALUE 1
	MAXVALUE 2147483647
	START 1
...
CREATE SEQUENCE IF NOT EXISTS invoicing.invoice_taxes_id_seq
	INCREMENT BY 1
	MINVALUE 1
	MAXVALUE 2147483647
	START 1
...
CREATE SEQUENCE IF NOT EXISTS invoicing.invoices_id_seq
	INCREMENT BY 1
	MINVALUE 1
	MAXVALUE 2147483647
	START 1
...
CREATE SEQUENCE IF NOT EXISTS invoicing.seller_smtp_settings_id_seq
	INCREMENT BY 1
	MINVALUE 1
	MAXVALUE 2147483647
	START 1
...
CREATE SEQUENCE IF NOT EXISTS invoicing.sellers_id_seq
	INCREMENT BY 1
	MINVALUE 1
	MAXVALUE 2147483647
	START 1
...
CREATE TABLE IF NOT EXISTS invoicing.sellers (
...
CREATE UNIQUE INDEX IF NOT EXISTS clients_siret_unique_idx ON invoicing.clients USING btree (siret) WHERE (is_company AND (country_code = 'FR'::bpchar) AND (siret IS NOT NULL));
CREATE INDEX IF NOT EXISTS idx_clients_seller_id ON invoicing.clients USING btree (seller_id);
...
CREATE UNIQUE INDEX IF NOT EXISTS uniq_invoice_seller_year_number ON invoicing.invoices USING btree (seller_id, fiscal_year, invoice_number);
...
create or replace trigger prevent_delete_non_draft_trigger before
delete
    on
...
CREATE TABLE IF NOT EXISTS invoicing.seller_smtp_settings (
	id serial4 NOT NULL,
...
CREATE TABLE IF NOT EXISTS invoicing.invoice_attachments (
	id serial4 NOT NULL,
...
CREATE TABLE IF NOT EXISTS invoicing.invoice_client (
	id serial4 NOT NULL,
	invoice_id int4 NOT NULL,
...
create or replace trigger invoice_client_sync_client_insert before
insert
    on
    invoicing.invoice_client for each row execute function invoicing.upsert_client_from_invoice();
create or replace trigger invoice_client_sync_client_update before
update
    on
    invoicing.invoice_client for each row execute function invoicing.upsert_client_from_invoice();
...
create or replace trigger invoice_lines_totals_trigger after
insert
    or
update
    on
    invoicing.invoice_lines for each row execute function invoicing.update_invoice_totals();
create or replace trigger invoice_lines_totals_trigger_delete after
delete
    on
    invoicing.invoice_lines for each row execute function invoicing.update_invoice_totals();
...
CREATE INDEX IF NOT EXISTS idx_invoice_status_invoice_id ON invoicing.invoice_status USING btree (invoice_id);
...
CREATE TABLE IF NOT EXISTS invoicing.invoice_taxes (
